                  ...
                  <div class="mb-4">
                    <div class="job-text">
                      ...
                      <ul class="mt-4">
                        ...
                        <div class="row">
                            <a href="<?= $router->route('app.pagamentorotapagseguro', ['id' => $rota->id_venda]) ?>" class="btn btn-primary btn-lg btn-teste active">Pagar</a>
                            <a href="<?= $router->route('app.cancelarrota', ['id' => $rota->id_venda]) ?>" class="btn btn-danger btn-lg btn-teste active">Cancelar</a>
                        </div>
                    </div>
                  </div>
