    ...
    <div class="main-content">
      <div class="single-content1">
        <div class="single-job mb-4 justify-content-between">
          <div class="job-text">
            <h1 style="color: #6c757d; text-align: center">Pagamentos Efetuados</h1>
            <ul class="mt-4">
              ...
              if (!empty($rotas)):
                foreach ($rotas as $rota):
                  if ($rota->tipo == "2" || $rota->tipo == "3" || $rota->tipo == "4" || $rota->tipo == "5" || $rota->tipo == "8" || $rota->tipo == "9"):
                  ...
                  <div class="mb-4">
                    <div class="job-text">
                      ...
                      <div class="row">
                        <a href="<?= $router->route('app.detalhepagamento', ['id'=>$rota->id_venda]) ?>" class="btn btn-primary btn-lg btn-block active">Detalhes</a>
                      </div>
                    </div>
                  </div>
