                    ...
                    <div class="card">
                        <div class="padding-20">
                            <ul class="nav nav-tabs" id="myTab2" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#comentarios" role="tab"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="profile-tab2" data-toggle="tab" href="#vendas" role="tab"
                                       aria-selected="false">Rotas Contratadas</a>
                                </li>
                            </ul>
                            ...
                            <div class="tab-pane fade" id="comentarios" role="tabpanel" aria-labelledby="profile-tab2">
                                  <form action="<?= $router->route("admin.salvarMotorista"); ?>" method="post" enctype="multipart/form-data">
                                      <div class="card-header">
                                          <h4>Comentarios do <?= $login->nome ?></h4>
                                      </div>
                                      ...
                                      <div class="card-body">
                                          ...
                                          <div class="card">
                                              <div class="card-body">
                                                  <div id="accordion">
                                                    <?php if(!empty($comentarios)):  foreach ($comentarios as $comentario):?>
                                                      <div class="accordion">
                                    ...
                                    <div class="tab-pane fade" id="vendas" role="tabpanel" aria-labelledby="profile-tab2">
                                        <div class="card-header">
                                            <h4>Rotas do <?= $login->nome ?></h4>
                                        </div>
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-striped dataTable no-footer" id="table-1" style="width:100%;">
                                                    ...
                                                    <tbody>
                                                    <?php if(!empty($vendas)): foreach ($vendas as $venda): if ($venda->status == "F"){$venda->status = "Finalizada";}elseif ($venda->status == "A"){$venda->status = "Andamento";}else{$venda->status = "Cancelada";}?>
                                                    <tr>
                                                        <td><?= $venda->id ?></td>
                                                        <td><?= $venda->nome ?></td>
                                                        <td><?= $venda->date ?></td>
                                                        <td>R$:<?=number_format($venda->valor,2,",",".") ?></td>
                                                        <td><?php if ($venda->status == "Finalizada"){ ?>
                                                        ...
                                                        <td><?= $venda->rota_id ?></td>
                                                        <td>
                                                            <a href="#" class="btn btn-icon icon-left btn-info"><i class="fas fa-info-circle"></i>Ver Mais</a>
                                                        </td>
                                                    </tr>
                                                    <?php endforeach; endif;?>
                                                    </tbody>
